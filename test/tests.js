...
context('Integration Testing', () => {
  ...
  it('Test 2: Check That offcanvas opens and closes', async function () {
    this.timeout(config.timeout);
  ...
  it('Test 3: Check that The offcanvas contains constituency data', async function () {
    this.timeout(config.timeout);
  ...
  it('Test 4: Check that the constituency leaderboard displays', async function () {
    this.timeout(config.timeout);
  ...
  it('Test 5: Check that the report leaderboard displays', async function () {
    this.timeout(config.timeout);
  ...
  it('Test 6: Check that the councillor information loads when button pressed', async function () {
    this.timeout(config.timeout);
  ...
  it('Test 7: Check that clicking on the pothole ID opens the correct councillor info', async function () {
    this.timeout(config.timeout);
  ...
  it('Test 8: Test Driver Report', async function () {
    this.timeout(config.timeout);
